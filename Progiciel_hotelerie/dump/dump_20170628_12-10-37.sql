...
INSERT INTO `agence` VALUES (1,'AZUR_DIFFUSION',675621538,'azur_diffusion@gmail.com'),(2,'CAPITAL EVASION',698585463,'capital_evasion@gmail.com'),(3,'SUD EVASION',612365485,'sud_evasion@gmail.com'),(4,'EURO MER AVIGNON',645695874,'euro_mer@gmail.com'),(5,'SOLOWAYS',605238759,'soloways@gmail.com'),(6,'SELECTOUR MASSILIA VOYAGES',698811311,'selectour@gmail.com'),(7,'Move Around Provence',629424352,'move@gmail.com'),(8,'CLUB MED',621252635,'club_med@gmail.com');
...
INSERT INTO `criticite` VALUES (1,'Très faible','00:20:00'),(2,'Faible','00:30:00'),(3,'Moyen','01:00:00'),(4,'Haute','01:30:00'),(5,'Très Haute','02:00:00'),(6,'Critique','02:30:00');
...
CREATE TABLE `demande_intervention` (
  ...
  KEY `id_etat` (`id_etat`),
  CONSTRAINT `fk_demandeur` FOREIGN KEY (`id_demandeur`) REFERENCES `utilisateur` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_etat` FOREIGN KEY (`id_etat`) REFERENCES `etat` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `demande_intervention` VALUES (1,'2017-07-12','réparation de la lampe','description',0,2,NULL,1,NULL,1,2,1),(2,'2017-07-11','réparation de la table','Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a libero neque. Suspendisse quis egestas arcu. Suspendisse porta mi vitae felis elementum, non venenatis dui euismod. Suspendisse erat magna, feugiat eget porttitor molestie, porttitor sed.',1,3,NULL,2,NULL,2,1,1),(3,'2017-07-10','réparation de la douche','description',0,1,3,NULL,NULL,3,1,2),(4,'2017-07-09','changement du frigo','description',1,4,4,NULL,NULL,4,8,1),(5,'2017-07-08','réparation de la cafetière','description',0,6,NULL,NULL,5,5,1,3),(6,'2017-07-07','réparation de la baignoire','description',1,2,NULL,NULL,6,6,1,3),(7,'2017-07-06','réparation de la fenêtre','description',0,3,NULL,5,NULL,7,9,4),(8,'2017-07-05','réparation de la vitre','description',1,5,NULL,4,NULL,8,1,2);
...
INSERT INTO `etat` VALUES (1,'Prise de connaissance'),(2,'En cours'),(3,'A valider'),(4,'Clôturer');
...
INSERT INTO `plat` VALUES (1,'Côte d’agneau Tandoori',20),(2,'Bar du Chili feuilleté sauce coréenne',35),(3,'Homard en salade à la sauce kimchi',15),(4,'Bar mariné citron jaune / basilic',10),(5,'Fraises Gariguettes en tarte sablée ',27),(6,'Gaspacho d’artichaut à l’orange, langoustines rôties',30),(7,'Homard poché au court bouillon',50),(8,'Oeuf de poule bio au manioc truffé & jus de maracudja ',80);
...
CREATE TABLE `rapport` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_demande_intervention_2` (`id_demande_intervention`),
  KEY `id_demande_intervention` (`id_demande_intervention`),
  KEY `technicien` (`id_technicien`),
  CONSTRAINT `fk_demande` FOREIGN KEY (`id_demande_intervention`) REFERENCES `demande_intervention` (`id`),
  CONSTRAINT `fk_technicien` FOREIGN KEY (`id_technicien`) REFERENCES `utilisateur` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `rapport` VALUES (1,'2017-06-26','2017-06-30','avancement des travaux...',2,NULL),(2,'1970-01-01','1970-01-01','',3,10),(3,'1970-01-01','1970-01-01','',8,10),(6,'1970-01-01','1970-01-01','',1,10),(7,'1970-01-01','1970-01-01','',4,10);
...
INSERT INTO `reservation_hotel` VALUES (1,'2017-07-14','2017-07-12',1,1,0,'test',2,1,2,6),(2,'2017-06-24','2017-06-12',2,2,0,'',0,1,1,1),(3,'2017-08-17','2017-08-12',1,1,0,'',0,1,1,3),(4,'2017-07-18','2017-07-16',2,2,0,'',0,1,2,4),(5,'2017-08-21','2017-08-17',0,0,1,'',0,1,1,4),(6,'2017-06-17','2017-06-15',2,2,0,'',0,1,2,2),(7,'2017-07-12','2017-07-10',0,15,0,'',0,1,1,5),(8,'2017-08-29','2017-08-27',0,0,0,'',2,1,2,6);
...
INSERT INTO `role` VALUES (1,'Admin'),(2,'Direction'),(3,'Hébergement'),(4,'Réception'),(5,'Restaurant'),(6,'Spa'),(7,'Maintenance'),(8,'Entretien');
...
INSERT INTO `utilisateur` VALUES (1,'Tassel','Joan','joan','fdp',1),(2,'Troadec','Kevin','kevtro','breton',1),(3,'Thibault','tmv','tmv','tmv',1),(4,'BB','B','b','b',7),(5,'Thomas','Vincent','thv','',1),(6,'Directeur','hotel','direction','a',2),(7,'Directeur','restaurant','restaurant','a',5),(8,'Directeur','spa','spa','a',6),(9,'Directeur','hebergement','hebergement','a',3),(10,'Directeur','maintenance','maintenance','a',7),(11,'Directeur','reception','reception','a',4),(12,'Directeur','entretien','entretien','a',8);
...
-- Dump completed on 2017-06-28 12:10:39
