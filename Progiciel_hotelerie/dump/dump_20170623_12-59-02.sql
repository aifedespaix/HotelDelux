...
LOCK TABLES `aliment_commande_assoc` WRITE;
...
LOCK TABLES `client_agence_assoc` WRITE;
...
LOCK TABLES `commande_assoc` WRITE;
...
LOCK TABLES `commande_piece_assoc` WRITE;
...
LOCK TABLES `demande_intervention` WRITE;
...
LOCK TABLES `demande_utilisateur` WRITE;
...
LOCK TABLES `droit_role_assoc` WRITE;
...
LOCK TABLES `equipement_hotel` WRITE;
...
LOCK TABLES `equipement_restaurant` WRITE;
...
LOCK TABLES `equipement_spa` WRITE;
...
LOCK TABLES `facturation_assoc` WRITE;
...
LOCK TABLES `menu_plat_assoc` WRITE;
...
LOCK TABLES `piece_de_rechange` WRITE;
...
LOCK TABLES `plat_aliment_assoc` WRITE;
...
INSERT INTO `reservation_hotel` VALUES (1,'2017-07-14','2017-07-12',2,2,0,'',1,1,1),(2,'2017-06-15','2017-06-12',2,2,0,'',1,2,1),(3,'2017-08-17','2017-08-12',1,1,0,'',1,1,3),(4,'2017-07-18','2017-07-16',2,2,0,'',1,2,4),(5,'2017-08-21','2017-08-17',0,0,1,'',1,1,4),(6,'2017-06-17','2017-06-15',2,2,0,'',1,2,2),(7,'2017-07-12','2017-07-10',0,15,0,'',1,1,5),(8,'2017-08-29','2017-08-27',2,2,0,'',1,2,6);
...
LOCK TABLES `reservation_restaurant` WRITE;
...
LOCK TABLES `reservation_spa` WRITE;
...
LOCK TABLES `restaurant_assoc` WRITE;
...
-- Dump completed on 2017-06-23 12:59:03
